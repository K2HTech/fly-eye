...
| CAL-E2E-04 | Place A–D corners on both cameras.                                                                         | Every A–D point starts visibly unplaced. Each is placed explicitly with the reticle center on its painted intersection; both screens show the same immutable A–D court diagram and End A anchor. |
...
| CAL-E2E-06 | Solve a healthy three-frame calibration.                                                                   | The returned wireframe overlays every returned line in raw pixels on the exact seeded frame; quality and per-line diagnostics are visible.                                                       |
