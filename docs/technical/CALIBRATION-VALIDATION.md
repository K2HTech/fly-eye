...
| CAL-E2E-04 | Place A–D corners on both cameras.                                                                         | Both screens show the same immutable A–D court diagram and End A anchor; no camera-relative near/far wording changes the assignment.       |
